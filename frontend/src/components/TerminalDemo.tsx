...
const LINES = [
  ...
  { t: 'sys', text: 'Found 2 matching markets. Running deep analysis.' },
  { t: 'br', text: '' },
  { t: 'head', text: 'MARKET ANALYSIS' },
  { t: 'br', text: '' },
  { t: 'data', text: '  Platform      Market                     YES    Prob' },
  { t: 'data', text: '  Predict.fun   BTC > $95k by Mar 1        $0.62  62%' },
  { t: 'data', text: '  Opinion       BTC above $95,000 Sun      $0.58  58%' },
  { t: 'br', text: '' },
  { t: 'head', text: 'STATISTICAL EVALUATION' },
  { t: 'br', text: '' },
  { t: 'data', text: '  Model Probability:  71%' },
  { t: 'data', text: '  Market Probability: 58% (Opinion)' },
  { t: 'good', text: '  Edge:               +13%' },
  { t: 'good', text: '  Expected Value:     +$0.22 per $1' },
  { t: 'data', text: '  Confidence:         High' },
  { t: 'br', text: '' },
  { t: 'gold', text: '  >> BUY YES on Opinion at $0.58 (+13% edge)' },
  { t: 'warn', text: '  !! ARB DETECTED: Cross-platform spread $0.04' },
  { t: 'br', text: '' },
  { t: 'in', text: 'Execute option 1, 200 shares' },
  { t: 'sys', text: 'Placing order: 200 YES @ $0.58 on Opinion...' },
  { t: 'good', text: '  FILLED  200 YES @ $0.58 — Cost: $116.00' },
];
